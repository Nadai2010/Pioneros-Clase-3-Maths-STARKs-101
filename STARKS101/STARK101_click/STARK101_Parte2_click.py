...
'''
Tomamos una combinación lineal aleatoria de p0, p1 y p2, a la que llamaremos polinomio de composición (composition polynomial en inglés, o CP si lo abreviamos).
alpha0, alpha1 y alpha2 son elementos del field aleatorios obtenidos del verificador, o en nuestro caso, del channel.
Probar que CP es un polinomio garantiza, con alta probabilidad, que p0, p1, p2 son, a su vez, polinomios.
