...
y retorna el siguiente polinomio "plegado".
'''
...
y retorna el siguiente polinomio, el siguiente dominio y la evaluación de este siguiente polinomio en este siguiente dominio.
'''
