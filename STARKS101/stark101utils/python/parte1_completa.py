...
# Traza de los Cuadrados de Fibonacci:

'''
Para empezar, construiremos una lista a de longitud 1023, donde los dos primeros elementos serán objetos FieldElement que representan 1 y 3141592, respectivamente.
...
En este caso, Fx es el grupo multiplicativo de F, que obtenemos a partir de F omitiendo el cero.
'''
...
#p # VER SI QUITAMOS ESTA LÍNEA DE CÓDIGO.
...
# Calculando el inverso del generador:
w = FieldElement.generator()
w_inv = w.inverse()
...
Este simple trozo de código instanciará un channel object y enviará la raíz de su Árbol Merkle.
Más tarde, el objeto canal puede ser llamado para proporcionar números aleatorios o elementos de campo aleatorios.
'''
